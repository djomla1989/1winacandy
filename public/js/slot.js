...
$(document).ready(function() {
    ...
    * Stops a slot
    */
    Slot.prototype.stop = function(finalPos) {
        var _this = this,
            limit = 30;
        ...
        _this.si = window.setInterval(function() {
            ...
            if(_this.speed <= limit) {
                _this.finalPos(_this.el, finalPos);
                $(_this.el).spSpeed(0);
                $(_this.el).spStop();
                clearInterval(_this.si);
    ...
    */
    Slot.prototype.finalPos = function(el, finalPos) {
        var el = el,
            el_id,
            pos,
            posMin = 2000000000,
    ...
    */
    ...
    function printResult() {
        ...
        if(win[a.pos] === win[b.pos] && win[a.pos] === win[c.pos]) {
            ...
            res = "More luck next time!";
        }
        $('#result').html(res);
    }

    //create slot objects
    var a = new Slot('#slot1', 20, 1),
        b = new Slot('#slot2', 35, 2),
    ...
    */
    $('#control').click(function() {
        ...
        if(this.innerHTML == "Start") {
            ...
            c.start();
            this.innerHTML = "Stop";
            $("#control").removeClass("btn-primary").addClass("btn-danger");
            ...
            var results = getSlotResults(a, b, c);
            this.innerHTML = "Start";

            disableControl(); //disable control until the slots stop
            $("#control").removeClass("btn-danger").addClass("btn-primary");
