...
/**
 * Paypal Class
 * https://github.com/romaldyminaya/ci_paypal/blob/master/Paypal.php
 * https://github.com/romaldyminaya/ci_paypal/wiki/Documentation
 * @package     CodeIgniter
   ...
   // var   $sandbox_url  = 'https://api-3t.sandbox.paypal.com/nvp?';
    ...
    function pay(){
        ...
        if($this->config['production'] == TRUE){
            ...
            //svar_dump($this->sandbox_url.$vars);exit;
